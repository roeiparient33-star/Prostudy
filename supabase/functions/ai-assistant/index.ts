...
- לגרפים של נתונים (פיזור, קו, עמודות, עוגה, התפלגות, רגרסיה, מתאם) — השתמש בבלוק \`\`\`chart עם קונפיגורציית Chart.js תקינה כ-JSON בלבד: {"type":"...","data":{...},"options":{...}}. זה מתרנדר כגרף מקצועי בלי טעויות מיקום. אל תצייר גרפי נתונים ב-SVG.
