...
export const ALL_STEPS = [
  ...
  },
  {
    ...
    quick: true,
    title: 'לוח הבקרה שלך 📊',
    body: 'פה רואים הכל בבת אחת — כמה שעות למדת השבוע, כמה משימות נשארו, קורסים, נקודות. מקום טוב להתחיל ממנו כל יום.',
  },
  {
    id: 'streak',
    page: 'dashboard',
  ...
  },
  {
    ...
    quick: true,
    title: 'שעון הלימוד ⏱️',
    body: 'לוחצים "התחל" לפני שפותחים חומר — וזהו. כל דקה = קרדיט אחד לחנות. השעון מתאפס כל לילה בחצות.',
  },
  {
    id: 'pomodoro',
    page: 'dashboard',
    ...
    title: 'מצב פומדורו 🍅',
    body: '25 דק׳ לימוד, 5 דק׳ הפסקה — ואז חוזר. שיטה שעובדת ורוב הסטודנטים נשבעים בה. שווה לנסות.',
  },
  {
    id: 'tasks',
    page: 'tasks',
    ...
    quick: true,
    title: 'הוסף משימה ✅',
    body: 'מוסיפים עם תאריך, סוג ועדיפות. אפשר לסנן, לערוך ולסמן "הושלם" כשסיימת. פשוט וישיר.',
  },
  {
    id: 'courses',
    page: 'courses',
    ...
    title: 'הקורסים שלך 📚',
    body: 'כל קורס מקבל צבע ייחודי — אז כשמסתכלים על המשימות, ברור מיד מה שייך לאן. שווה להגדיר בתחילת סמסטר.',
  },
  {
    id: 'friends-invite',
    page: 'friends',
